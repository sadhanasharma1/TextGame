...
// idhr hmne check laga diya kii hamara prop string hi lega
//isRequired dalne se we ensure kii hamane ye chahiye hi chahiye
Navbar.propTypes={
    title: PropTypes.string,  
    aboutTitle: PropTypes.string
};
//If we do not pass the prop then ye values set ho jaungi by default:
Navbar.defaultProps={
